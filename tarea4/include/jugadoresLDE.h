...
// PRE: cantidadTJugadoresLDE(jugadores) > 0
// La función es Theta(1) peor caso.
...
// La función elimina (y liberar la memoria asignada) de la PRIMERA ocurrencia (de inicio a fin) de un jugador con el nombre "nombre" en la lista "jugadores".
// La función es Theta(n+m) peor caso, donde n es la cantidad de jugadores en la lista y m es la cantidad de jugadas de la partida del jugador a eliminar.
// PRE: existe un jugador de nombre "nombre" en la lista
void eliminarJugadorConNombreTJugadoresLDE(TJugadoresLDE &jugadores, const char nombre[100]);

// Función para verificar si un elemento de tipo TJugador existe en una lista de jugadores segun su nombre
// Devuelve true si existe, false en caso contrario
// La función es Theta(n) peor caso, siendo n la cantidad de jugadores en la lista
bool estaJugadorConNombreEnTJugadoresLDE(TJugadoresLDE jugadores, const char nombre[100]);

// Función para obtener la PRIMERA ocurrencia (de inicio a fin) de un jugador con el nombre "nombre" en la lista de jugadores
// La función es Theta(n) peor caso, siendo n la cantidad de jugadores en la lista
// PRE:  existe un jugador de nombre "nombre" en la lista
